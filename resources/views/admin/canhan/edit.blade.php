...
<div class="card" >
    <div class="card-body">
        <form action="{{route('canhan.update',$data->id)}}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf @method('PUT')
              <div class="form-group">
                <a href="{{route('canhan.index')}}" class="btn btn-sm btn-danger mb-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                  <div class="form-group">
                    <img class="rounded mx-auto d-block mb-2" src="{{url('public/uploads/canhan')}}/{{$data->avatar}}" id="image"  width="250px"/>
